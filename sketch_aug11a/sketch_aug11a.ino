...
const char* ssid = "Mustahi";
const char* password = "Mustahirahman";
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
void setup() {
  ...
  Serial.println("");
  myservo.attach(D3);  // Attach the servo to pin D1 on NodeMCU
  myservo.write(0);    // Initialize the servo to its starting position
  delay(1000);
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
void loop() {
  ...
  if(readsuccess) {  
    ...
    http.begin(wifiClient, "http://192.168.0.107/NodeMCU_RC522_Mysql/getUID.php");  //Specify request destination
